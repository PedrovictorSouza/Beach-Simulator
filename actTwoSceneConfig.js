...
export const ACT_TWO_PLAYER_SPAWN = [1.42, 0, 62.48];
export const ACT_TWO_PLAYER_CAMERA_DIRECTION = [0, 0.36, 1];
export const ACT_TWO_PLAYER_CAMERA_TARGET_HEIGHT = 1.2;
const ACT_TWO_PLAYER_CAMERA_ZOOM_OUT_SCALE = 1.25;
const ACT_TWO_PLAYER_STANDARD_CAMERA_ZOOM = 5.35;
const ACT_TWO_PLAYER_STANDARD_CAMERA_DISTANCE = 8.2 * ACT_TWO_PLAYER_CAMERA_ZOOM_OUT_SCALE;
export const ACT_TWO_PLAYER_CAMERA_ZOOM = 6.2;
export const ACT_TWO_PLAYER_CAMERA_DISTANCE = 10.2 * ACT_TWO_PLAYER_CAMERA_ZOOM_OUT_SCALE;
export const ACT_TWO_PLAYER_CAMERA_FOLLOW_LEAD = 1.6;
export const ACT_TWO_PLAYER_CAMERA_FOLLOW_VERTICAL_STRENGTH = 1;
export const ACT_TWO_GAMEPLAY_OPENING_CAMERA_HOLD = 6.4;
export const ACT_TWO_GAMEPLAY_OPENING_SHIP_START = 0.45;
export const ACT_TWO_GAMEPLAY_OPENING_SHIP_LAND = 2.2;
export const ACT_TWO_GAMEPLAY_OPENING_PLAYER_EXIT_START = 3.2;
...
export const ACT_TWO_PLAYER_CAMERA_ZOOM_PRESETS = Object.freeze([
  ...
  {
    id: "default",
    zoom: ACT_TWO_PLAYER_STANDARD_CAMERA_ZOOM,
    distance: ACT_TWO_PLAYER_STANDARD_CAMERA_DISTANCE
  }
]);
