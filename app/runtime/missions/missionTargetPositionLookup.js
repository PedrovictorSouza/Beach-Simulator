...
export function createGameplayMissionTargetPositionProvider({
  session = {},
  workbenchPosition = WORKBENCH_POSITION,
  ruinedPokemonCenterPosition = RUINED_POKEMON_CENTER_POSITION,
  getFreeBlockBuildZoneCenterPosition = () => null,
  getTargetPositionsById = getMissionTargetPositionsById
} = {}) {
  return function getGameplayMissionTargetPositionsById(targetId) {
    return getTargetPositionsById({
      targetId,
      session,
      workbenchPosition,
      ruinedPokemonCenterPosition,
