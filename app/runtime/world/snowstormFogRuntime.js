import {
  getSnowstormFogIntensity as getGameplaySnowstormFogIntensity
} from "../../session/snowstormParticleField.js";

const GAMEPLAY_SNOWSTORM_FOG_MAX_OPACITY = 0.54;
const GAMEPLAY_SNOWSTORM_FOG_OPACITY_EASE = 6.2;

export function createGameplaySnowstormFogRuntime({
  mount,
  clamp01,
  getSnowstormFogIntensity = getGameplaySnowstormFogIntensity,
  maxOpacity = GAMEPLAY_SNOWSTORM_FOG_MAX_OPACITY,
  opacityEase = GAMEPLAY_SNOWSTORM_FOG_OPACITY_EASE
} = {}) {
  return createSnowstormFogRuntime({
    mount,
